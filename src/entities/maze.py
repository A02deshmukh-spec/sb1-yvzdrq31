"""Maze class handling the game board"""

import pygame
from src.constants.colors import BLUE, WHITE
from src.constants.game_settings import CELL_SIZE
from src.constants.maze_layout import MAZE_LAYOUT
